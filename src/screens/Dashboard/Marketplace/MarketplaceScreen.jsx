...
const MarketplaceScreen = () => {
	...
	let [posts, setPosts] = useState(marketplacePosts);
	...
	useEffect(() => {
		setPosts((posts = marketplacePosts));
		// Filter by query
		setResults(
	...
	return (
		<div className="marketplace-page">
			<div className="searchBar">
				...
				<Link
					to="/dashboard/approve-marketplace-posts"
					onClick={() => {}}
					style={{
						display: unapprovedMarketplacePosts.length === 0 ? "none" : "",
					}}>
					<button className="main approve-new">
						<span className="notification-number">
							{unapprovedMarketplacePosts.length}
						</span>
						Approve new
					</button>
				</Link>
